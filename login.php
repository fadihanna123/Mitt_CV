        ...
        <div class='myfrm2'>
            ...
            <form action='login.php' method='post'>
                <div class='row'>
                    ...
                    <div class='col'>
                        <input placeholder='Email' type='email' id='logepost' name='logepost' autocomplete='off'
                            required />
                    </div>
                </div>
                ...
                <div class='row'>
                    ...
                    <div class='col'>
                        <input type='password' name='logpsw' id='logpsw' placeholder='Password' autocomplete='off'
                            required />
                    </div>
                </div>
