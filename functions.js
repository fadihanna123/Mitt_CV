	...
	function show(tabell)
        ...
        if(tabell = 'cv_studie')
        	...
        	.then((data) => {
        		...
        		document.getElementById('here2').innerHTML = output + '<a href="add.php?tabell=cv_studie">Lägg till data</a><br />';
        ...
        if(tabell = 'cv_work')
        	...
        	.then((data) => {
        		...
        		document.getElementById('here3').innerHTML = output + '<a href="add.php?tabell=cv_work">Lägg till data</a><br />';
        ...
        if(tabell = 'cv_webpages')
        	...
        	.then((data) => {
        		...
        		document.getElementById('here4').innerHTML = output + '<a href="add.php?tabell=cv_webpages">Lägg till data</a><br />';
