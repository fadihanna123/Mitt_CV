...
class Admin
{
	...
	{
		$this->db = new mysqli("localhost", "root", "", "test") or die("Det finns ett okänt problem");
	...
	{	
		...
		return $result = $this->db->query($sql) or die("<span class='error'>Det finns ett okänt problem - Vi försöker lösa problemet så fort det går.</span>");
